...
import com.ruoyi.framework.vo.MQEntity;
...
public class RedisUtils {
     ...
     * @return 成功个数
     */
    public Set<Object> sendSet(String key) {
        try {
            return redisTemplate.opsForSet().members("MQ"+key);
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @return 成功个数
     */
    public Set<Object> acceptSet(String key) {
        SetOperations<String, Object> stringObjectSetOperations = redisTemplate.opsForSet();
        try {

            Set<Object> members = stringObjectSetOperations.members("MQ" + key);
            return members;
        } catch (Exception e) {
            e.printStackTrace();
