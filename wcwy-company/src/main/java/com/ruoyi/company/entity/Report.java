...
public class Report implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getReportId() == null ? other.getReportId() == null : this.getReportId().equals(other.getReportId()))
            ...
            && (this.getReplenish() == null ? other.getReplenish() == null : this.getReplenish().equals(other.getReplenish()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getReplenish() == null) ? 0 : getReplenish().hashCode());
