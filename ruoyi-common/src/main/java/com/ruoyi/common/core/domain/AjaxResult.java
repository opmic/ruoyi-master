...
public class AjaxResult<T> extends HashMap<String, Object>
{
     ...
     * @param msg 返回内容
     */
    public <T> AjaxResult(int code, String msg)
    {
     ...
     * @param data 数据对象
     */
    public <T> AjaxResult(int code, String msg, Object data)
    {
        super.put(CODE_TAG, code);
        super.put(MSG_TAG, msg);
     ...
     * @return 警告消息
     */
    public static AjaxResult modified(String msg)
    {
        return AjaxResult.modified(msg, null);
    }
     ...
     * @return 警告消息
     */
    public static <T> AjaxResult modified(String msg, T data)
    {
